...
train_file = par_dir + "train.txt"  # The path of the training txt file.
val_file = par_dir + "val.txt"  # The path of the validation txt file.
data_file = par_dir + 'container.txt'  # The path of the validation txt file.

restore_path = './data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
save_dir = par_dir + 'checkpoint/'  # The directory of the weights to save.
log_dir = par_dir + 'logs/'  # The directory to store the tensorboard log files.
progress_log_path = par_dir + 'progress.log'  # The path to record the training progress.
anchor_path = par_dir + 'container_anchors.txt'  # The path of the anchor txt file.
class_name_path = par_dir + 'container.names'  # The path of the class names.
...
train_img_cnt , val_img_cnt = len(train_img),len(val_img)
